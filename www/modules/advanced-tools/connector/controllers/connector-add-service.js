angular.module('vxl-mobile.connector').controller('connectorAddServiceCtrl',function($scope,$ionicPopup) {
    ...
    {       
        ...
        if ($scope.connector.serviceurl === " " || $scope.connector.serviceurl === undefined) {
          $scope.validateMain($scope.connector.serviceurl,"Please Enter URL"); return false; }

        if (!($scope.connector.serviceurl).match(urlExp)) {
            $scope.validateMain($scope.connector.serviceurl,"Please Enter URL in Proper Formate"); return false;  }
