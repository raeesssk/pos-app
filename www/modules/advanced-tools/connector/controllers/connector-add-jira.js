angular.module('vxl-mobile.connector').controller('connectorAddJiraCtrl',function($scope,$ionicPopup,ConnectorService,$state) {
    ...
    $scope.AddJiraData = function () {
       ConnectorService.createJiraDataSource($scope.connector).then(
        function (data)
        {
